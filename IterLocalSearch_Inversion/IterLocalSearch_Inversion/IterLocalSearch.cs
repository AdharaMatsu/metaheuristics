namespace IterLocalSearch_Inversion
{
    public static class IterLocalSearch
    {
        ...
        public static void Run(string filename)
        {
            ...
            while (iteraciones > 0)
            {
                ...
                {
                    solucionInicial = Inversion(solucionVecina);
                }
        ...
        private static int[] Inversion(int[] solucion)
        {
            int[] nuevaSolucion = solucion.ToArray();
            int nodo_rnd_A = rnd.Next(1, solucion.Length);
            int nodo_rnd_B = rnd.Next(1, solucion.Length);

            // Asegurarnos de que nodo_rnd_A sea menor que nodo_rnd_B
            if (nodo_rnd_A > nodo_rnd_B)
            {
                int temp = nodo_rnd_A;
                nodo_rnd_A = nodo_rnd_B;
            ...
            // Invertir el segmento entre nodo_rnd_A y nodo_rnd_B
            while (nodo_rnd_A < nodo_rnd_B)
            {
                int temp = nuevaSolucion[nodo_rnd_A];
                nuevaSolucion[nodo_rnd_A] = nuevaSolucion[nodo_rnd_B];
                nuevaSolucion[nodo_rnd_B] = temp;
                nodo_rnd_A++;
                nodo_rnd_B--;
            }
